...
@task
def generate_process(process_id,num_jobs,file_name,path,identity_cutoff=5,e_value_cutoff=0.97):
...
@task
def call_search_process(process_id,search_name,path,num_jobs,identity_cutoff=5,e_value_cutoff=0.97):
